...
const PrivacyPolicy = () => (
  <LegalPageLayout title="Privacy Policy" description="How Pennyekart collects, uses, shares and deletes your personal information.">
    ...
    <ul>
      <li><b>Account and login:</b> name, mobile number, email, password (stored encrypted by our login provider), date of birth (to confirm you are old enough to use the service), panchayath/municipality and ward (to show products and services available in your area).</li>
      ...
      <li><b>Photos:</b> images you choose from your phone to upload for products or your profile photo. The app does not use the camera directly.</li>
    ...
    <h2>Your rights</h2>
    <p>You can view and edit your profile, turn off notifications, deny location, photo or microphone access, and request deletion of your data.</p>
